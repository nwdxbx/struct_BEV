...
# dstdir = "/media/xubenxiang/data/suzhou_C03/images/suzhou0523_image/"
# bagdir = "/media/xubenxiang/data/suzhou_C03/rosbags/suzhou_0523/"
# bag_subdirs = ["day_morning", "vertical_road", "qlg-ntc_InvClockwise",
# 		  "qlg-ntc_clockwise", "qlg-hxj_InvClockwise", "qlg-hxj_clockwise", "day_extra"]

# bag_subdirs = ["night", "night_extra"]

# dstdir = "/media/xubenxiang/L4TeamShare/Datasets/C03/jiakao/images"
dstdir = "/media/xubenxiang/L4TeamShare/Datasets/L12/rosbag/images"
bagdir = "/media/xubenxiang/L4TeamShare/Datasets/L12/rosbag/"
bag_subdirs = ["night"]

topics = ["/driver/camera/front_s/image/compressed", 
		 ]

# topics = ["/driver/camera/front_l/image/compressed", "/driver/camera/front_s/image/compressed", 
# 		 ]
...
bridge = CvBridge()
for subdir in bag_subdirs:
	bag_subpath = os.path.join(bagdir, subdir)
	sub_bags = os.listdir(bag_subpath)
	sub_bags = ["2024-11-20-18-53-45.bag"]
	for bagfile in sub_bags:
		bagpath = os.path.join(bag_subpath, bagfile)
		parseros2img(bridge, bagpath, dstdir, subdir, bagfile)


# cmd = "rosrun pcl_ros bag_to_pcd %s %s %s" % (bagpath, pointclout_topic pointcloud_output_dir)
# os.system(cmd)