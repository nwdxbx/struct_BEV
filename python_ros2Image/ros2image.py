...
bagdir = "/media/xubenxiang/PerceptionTeam_L4/wangxin/Suzhou/0120"
bagfile = "2024-01-21-09-53-50_cross_objclear.bag"

dstdir = "/media/xubenxiang/PerceptionTeam_L4/wangxin/Suzhou/0120/2024-01-21-09-53-50_cross_objclear"
...
print(info)
topics = ["/driver/camera/front_l/image/compressed", "/driver/camera/front_m/image/compressed", 
...
for i, topic_name in enumerate(topics):
	...
	for topic, msg, t in bag_data:
		...
		imgdir = os.path.join(dstdir, camera)
